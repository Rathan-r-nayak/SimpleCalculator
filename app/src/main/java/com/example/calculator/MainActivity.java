...
public class MainActivity extends AppCompatActivity {
    ...
    public void one(View v)
    {
        ...
        else if(number2.hasFocus())
        {
            ...
            Toast.makeText(this, "Please select first/second number field", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void dot(View v)
    {
        ...
        else if(number2.hasFocus())
        {
            ...
            Toast.makeText(this, "Please select number1/number2 field", Toast.LENGTH_LONG).show();
        }
    }
